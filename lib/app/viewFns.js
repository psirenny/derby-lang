module.exports = function (app) {
  app.view.fn('t', function () {
    ...
    var $context = this.model.at('$lang.context');
    var $formats = this.model.at('$lang.formats');
    $formats.setNull('locale.' + language, Function('return ' + $context.get('locale.' + language))());
    ...
    viewFn = Function('MessageFormat', $context.get('inc') + 'return ' + translation)($formats.get());
