module.exports = function (app) {
  app.view.fn('t', function () {
    ...
    $formats.setNull('locale.' + language, Function($context.get('inc') + 'return ' + $context.get('locale.' + language))());
    ...
    viewFn = Function('MessageFormat', 'return ' + translation)($formats.get());
